-- ============================================================================
-- Hypernova: Assessment Revenue — Last 24h
-- ============================================================================
-- USDC received in the last 24 hours from eval account purchases: transfers
...
recent_transfers AS (
    ...
    WHERE tr."to" = 0x924e3Ed4fc2130b103470270B403b2A4ac808240   -- Hypernova address
        ...
        AND tr.evt_block_time >= NOW() - INTERVAL '24' HOUR
)
