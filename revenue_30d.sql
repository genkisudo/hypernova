-- ============================================================================
-- Hypernova: Assessment Revenue — Last 30 Days (Verified)
-- ============================================================================
-- Verified USDC revenue in the last 30 days: only payments that match 1:1
...
SELECT
    SUM(amount_usdc) AS revenue_usdc_30d
