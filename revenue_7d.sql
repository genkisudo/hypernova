-- ============================================================================
-- Hypernova: Assessment Revenue — Last 7 Days (Verified)
-- ============================================================================
-- Verified USDC revenue in the last 7 days: only payments that match 1:1
...
SELECT
    SUM(amount_usdc) AS revenue_usdc_7d
